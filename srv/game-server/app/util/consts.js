...
module.exports = {
    ...
    TYPE_MSG:{
        ...
        TYPE_MSG_LOCK_CARD_ALREADY:10,
        TYPE_MSG_CANCEL_HOSTING:11,
        TYPE_MSG_GET_MISSION_AWARD:12,
        TYPE_MSG_GET_MISSION_DATA:13,
        TYPE_MSG_LEAVE_GAME:14,
        TYPE_MSG_READY_HAND_CARDS:15
    },
    TYPE_NOTICE:{
    ...
    GAME_STATUS:{
        ...
        GAME_STATUS_WAITING_DISCARD:4,
        GAME_STATUS_QUESTION_READY_HAND:5,
    ...
    MISSION_STATUS:{
        MISSION_STATUS_UNFINISHED:0,
        MISSION_STATUS_FINISHED:1,
        MISSION_STATUS_OBTAINED:2
    },
    MISSION_ID:{
        MISSION_ID_LOGIN_AWARD:1,
        MISSION_ID_PLAY_WITH_FRIEND:2,
        MISSION_ID_EVER_VICTORIOUS_GENERAL:3,
